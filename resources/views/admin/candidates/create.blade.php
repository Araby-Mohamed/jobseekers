                                            ...
                                            <div class="portlet light ">
                                                <div class="portlet-title">
                                                    <div class="caption">
                                                        ...
                                                        <span class="caption-subject font-green-haze bold uppercase">Add Candidate</span>
                                                    </div>
                                                ...
                                                <div class="portlet-body form">
                                                    ...
                                                    <!-- BEGIN FORM-->
                                                    <form role="form" method="post" action="{{url('admin/candidates/store')}}" enctype="multipart/form-data">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-3">
                                                                    <div class="form-group{{ $errors->has('birthday') ? ' has-error' : '' }}">
                                                                        ...
                                                                        <div class="input-group date">
                                                                            <input type="text" class="form-control m-input" name="birthday" placeholder="Select date" value="{{old('birthday')}}" id="m_datetimepicker_6" id="birthday">
                                                                ...
                                                                <div class="col-md-3">
                                                                    <div class="form-group{{ $errors->has('jop_title') ? 'has-error' : '' }}">
                                                                        ...
                                                                        <input type="text" required name="jop_title" class="form-control" id="jop_title" value="{{old('jop_title') }}" placeholder="Enter Job Title">
                                                                    </div>
                                                                </div><!-- /.col-md-3 -->
                                                                ...
                                                                <div class="col-md-12">
                                                                    <div class="form-group{{ $errors->has('Description') ? 'has-error' : '' }}">
                                                                        ...
                                                                        <textarea class="form-control" id="Description" name="Description" rows="10" placeholder="Enter Description">{{old('Description') }}</textarea>
                                                                    </div>
                                                                </div><!-- /.col-md-12 -->
                                                                ...
                                                                <div class="col-md-3">
                                                                    <div class="form-group{{ $errors->has('website') ? 'has-error' : '' }}">
                                                                        <label>Website</label>
                                                                        <input type="url" name="website" class="form-control" id="website" value="{{old('website')}}" placeholder="Enter Website">
                                                                    </div>
                                                                </div><!-- /.col-md-3 -->
                                                                ...
                                                                <div class="col-md-3">
                                                                    <div class="form-group{{ $errors->has('facebook') ? 'has-error' : '' }}">
                                                                        ...
                                                                        <input type="url" name="facebook" class="form-control" id="facebook" value="{{old('facebook')}}" placeholder="Enter Facebook">
                                                                    </div>
                                                                </div><!-- /.col-md-3 -->
                                                                ...
                                                                <div class="col-md-3">
                                                                    <div class="form-group{{ $errors->has('twitter') ? 'has-error' : '' }}">
                                                                        <label>Twitter</label>
                                                                        <input type="url" name="twitter" class="form-control" id="twitter" value="{{old('twitter')}}" placeholder="Enter Twitter">
                                                                    </div>
                                                                </div><!-- /.col-md-3 -->
                                                                ...
                                                                <div class="col-md-3">
                                                                    <div class="form-group{{ $errors->has('linkedin') ? 'has-error' : '' }}">
                                                                        ...
                                                                        <input type="url" name="linkedin" class="form-control" id="linkedin" value="{{old('linkedin')}}" placeholder="Enter Linkedin">
                                                                    </div>
                                                                </div><!-- /.col-md-3 -->
